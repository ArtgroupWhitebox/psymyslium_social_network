...
import { getUsersThunk, unFollowThunk, followThunk, setIsScan, setTurnByName, setIsFriends, setCurrentPage } from '../../redux/users_reducer'
...
import { addMessageThunk, clearMessagesThunk, getUserMessagesThunk, getUsersDialogsThunk, startUserInChattinggThunk } from '../../redux/dialogs_reducer'
...
export default compose(
    connect(mapStateToProps, {getUsersThunk, followThunk, unFollowThunk, getUsersDialogsThunk, addMessageThunk,
        ...
        setCurrentPage, startUserInChattinggThunk })
    )(UsersContainer)
